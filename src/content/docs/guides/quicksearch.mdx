...
Quicksearch allows you to filter processes using simple text or regular expressions. The search is performed on the properties selected in the Quick-search filter and within the context of current user filter and selected view type.
It is useful to quickly filter processes further without having to create or modify user filters.
